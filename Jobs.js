      ...
      jobsList.filter((job) =>
        filters.department !== ""
          ? job.department === filters.department &&
            job.category.includes(filters.category) &&
            job.type.includes(filters.type) &&
            ...
            <tbody>
              {filteredData.length === 0 ? (
                ...
                filteredData
                  .slice(
                    (pageNo - 1) * perPage,
                    (pageNo - 1) * perPage + perPage <= jobsList.length
                  ...
                  .map((job, i) => (
                    <tr key={i}>
                      ...
                      <td>
                        {
                          departments.filter(
                            (d) => d.code === job.department
                          )[0].title
                        }
                      </td>
                      <td>
                        {
                          categories.filter((c) => c.code === job.category)[0]
                            .title
                        }
                      </td>
                      <td>
                        {types.filter((t) => t.code === job.type)[0].title}
                      </td>
